...
const DesktopRenderListItem = (item, props) => {
	...
	const timeline_icon = Number(item.remaining_count) > 0 ? item.remaining_count : <antd_icons.CheckCircleFilled style={{ background: "transparent", color: "green", fontSize: "2em", marginRight: -5 }} />;
