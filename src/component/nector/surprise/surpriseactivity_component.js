...
//from app
class SurpriseActivityListComponent extends React.Component {
	constructor(props) {
		super(props);
...
SurpriseActivityListComponent.propTypes = properties;

export default SurpriseActivityListComponent;