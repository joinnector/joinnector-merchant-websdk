...
const MobileRenderListItem = (item, props) => {
	...
	return (
		<antd.List.Item className="nector-list-item" style={{ backgroundColor: "white", borderRadius: 4, padding: "15px", paddingLeft: 10, margin: "0px 5px", marginBottom: 20, boxShadow: "rgba(0, 0, 0, 0.1) 0px 1px 3px 0px, rgba(0, 0, 0, 0.06) 0px 1px 2px 0px" }} onClick={() => props.on_offer(item)}>
			<antd.List.Item.Meta
