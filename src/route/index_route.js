	...
	return (<AppContainer>
		<framer_motion.AnimatePresence exitBeforeEnter>
			<react_router_dom.Switch>
				...
				<react_router_dom.Route exact path="/nector/dealvoucher-list" component={NectorContainer.DealVoucherListContainer} />
				<react_router_dom.Route exact path="/nector/dealmonetory-list" component={NectorContainer.DealMonetoryListContainer} />
