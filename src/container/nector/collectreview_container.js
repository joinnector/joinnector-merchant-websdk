...
import CollectReviewComponent from "../../component/nector/collectreview_component";
...
class CollectReviewContainer extends React.Component {
		...
		return (
			<LazyMotion features={domAnimation}>
				<m.div
					...
					<CollectReviewComponent {...this.props} />
				</m.div>
			</LazyMotion>
		);
	}
...
CollectReviewContainer.propTypes = properties;
...
export default react_router_dom.withRouter(react_redux.connect(map_state_to_props, map_dispatch_to_props, null, { pure: false })(CollectReviewContainer));