...
import DealComponent from "../../../component/nector/deal/deal_component";
...
export default react_router_dom.withRouter(react_redux.connect(map_state_to_props, map_dispatch_to_props, null, { pure: false })(DealContainer));